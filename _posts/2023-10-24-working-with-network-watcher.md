---
layout: post
title: "Labs from IaC Workshop: Working with Azure Network Watcher"
date: 2023-10-24
description: "Level 200 workshop that covered different aspects of working with Azure Network Watcher."
image: "/images/2023-10-24-logo.png"
categories: ["Bicep", "Workshops", "Infrastructure as Code", "Azure Network Watcher"]
githubissuesid: 40
---

![logo](/images/2023-10-24-logo.png)

Last week I held [Working with Azure Network Watcher](https://www.meetup.com/infrastructure-as-code-user-group-oslo/events/294715449) master class under my [Infrastructure as Code user group](https://www.meetup.com/Infrastructure-As-Code-User-Group-Oslo).

This time we looked at different aspects aspects of working with Azure Network Watcher and you will learn:
...
As always, labs are [available](https://workshops.iac-labs.com/azure-network-watcher/) and you are welcome to work with them.

Here is IaC workshops road-map for 2023:

- Working with Azure Policies (November)
- Azure Landing Zones 101 (December)
